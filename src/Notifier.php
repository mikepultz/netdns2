...
class Notifier extends DNS2
{
    ...
    public function __construct(string $zone, ?array $options = null)
    {
        ...
        $this->packet->header->opcode = \Net\DNS2\Lookups::OPCODE_NOTIFY;
    }
    ...
    public function signature(string $keyname, string $signature, string $algorithm = \Net\DNS2\RR\TSIG::HMAC_MD5): bool
    {
     ...
     * @throws \Net\DNS2\Exception
     */
    public function notify(?\Net\DNS2\Packet\Response &$response = null): bool
    {
        if ($this->auth_signature instanceof \Net\DNS2\RR\TSIG
            || $this->auth_signature instanceof \Net\DNS2\RR\SIG
        ) {
